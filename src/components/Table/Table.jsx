...
const headCells = [
  { id: 'video', disablePadding: true, label: 'Videos' },
  { id: 'visibility', disablePadding: true, label: 'Visibility'},
...
export default function EnhancedTable({ rows }) {
  ...
  const handleSelectAllClick = (event) => {
    if (event.target.checked) {
      const newSelecteds = rows.map((n) => n.video);
                      ...
                      >
                        <div style={{ display: 'flex' }}>
                          <img
                            ...
                            src={`${REACT_APP_DEV_UPLOAD_URL}/${row.thumbnail}`}
                          />
                          <p>{row.video}</p>
                        </div>
                      </TableCell>
                      <TableCell>{capitalize(row.visibility)}</TableCell>
                      <TableCell size="small" > {new Date(row.date).toDateString()}</TableCell>
